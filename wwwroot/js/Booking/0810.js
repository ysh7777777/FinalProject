...
//     passengerInput.addEventListener("input", updatePassengerSummary);
//     luggageInput.addEventListener("input", updatePassengerSummary);
//     babySeatInput.addEventListener("input", updatePassengerSummary);
...
// });
/* 0812 END 乘客資訊同步到訂單總覽 ------------------------------------------------------------------------------------------- */

/* 0812 STR 建立統一的 updateOrderSummary() ------------------------------------------------------------------------------------------- */
...
//     document.getElementById("summaryPassengers").textContent = `${passengerInput.value} 人`;
//     document.getElementById("summaryLuggage").textContent = `${luggageInput.value} 件`;
//     document.getElementById("summaryBabySeat").textContent = `${babySeatInput.value} 張`;
...
//     if (selectedCar) {
//         const carName = selectedCar.dataset.carName;
//         const price = selectedCar.dataset.price;
...
//             </strong>
//             <div class="small text-muted mt-1">
//                 NT$${Number(price).toLocaleString()} 起
//             </div>
//         `;
//     }
...
//     updateFlightSummary();
// }
/* 0812 END 建立統一的 updateOrderSummary() ------------------------------------------------------------------------------------------- */
